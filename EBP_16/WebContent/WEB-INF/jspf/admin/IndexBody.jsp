...
<script type="text/javascript">
	...
	var mounth=(new Date()).getMonth().toString();
	
	document.getElementById("time").value=year;
</script>
<h2><img src="images/icon-modifyInfo.jpg" /> 您好 ${session_admin.username } 管理员，欢迎来到615+R电子商务平台！</h2>
<div id="content" class="container_16 clearfix">
	...
	<div class="grid_5">
					...
					<div class="box">
						...
						<table class="date">
							<caption><a href="#">Prev</a>July 2017<a href="#">Next</a> </caption>
							<thead>
								<tr>
									<th>Sun</th>
									<th>Mon</th>
